        ...
        <nav class="navbar">
            <div class="nav-container">
                ...
                <ul class="nav-menu">
                    ...
                    <li><a href="dominicana.php" class="nav-link active">República Dominicana</a></li>
                    <li><a href="../colombia/colombia.php" class="nav-link">Colombia</a></li>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="../colombia/colombia.php">Colombia</a></li>
                        <li><a href="../colombia/colombia.php#antioquia">Antioquia</a></li>
                    </ul>
                </div>
                <div class="footer-section">
