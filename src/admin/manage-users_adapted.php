    ...
    if (empty($nombre) || empty($apellido) || empty($email)) {
        ...
        if (empty($id)) {
            ...
            if (!empty($password)) {
                ...
                $stmt = mysqli_prepare($conexion, $query);
                mysqli_stmt_bind_param($stmt, "ssssi", $nombre, $apellido, $email, $password_hash, $id);
            } else {
        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="apellido" name="apellido" required 
                               value="<?php echo isset($_GET['edit']) ? htmlspecialchars($_GET['apellido'] ?? '') : ''; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <a href="manage-users_adapted.php" class="btn btn-secondary">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="user-actions">
                                    <a href="manage-users_adapted.php?edit=<?php echo $user['id']; ?>&nombre=<?php echo urlencode($user['nombre']); ?>&apellido=<?php echo urlencode($user['apellido']); ?>&email=<?php echo urlencode($user['email']); ?>" 
                                       class="btn btn-success btn-small">
                                        <i class="fas fa-edit"></i> Editar
                                    </a>
                                    <a href="assign-roles.php?id=<?php echo $user['id']; ?>" 
